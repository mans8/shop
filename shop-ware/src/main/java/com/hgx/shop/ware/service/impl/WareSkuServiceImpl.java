...
import com.hgx.shop.ware.feign.OrderFeignService;
import com.hgx.shop.ware.feign.ProductFeignService;
import com.hgx.shop.ware.service.WareOrderTaskDetailService;
import com.hgx.shop.ware.service.WareOrderTaskService;
import com.hgx.shop.ware.vo.OrderItemVo;
...
import com.hgx.shop.ware.dao.WareSkuDao;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
    ...
    public Boolean orderLockStock(WareSkuLockVo vo) {
        ...
        taskEntity.setOrderSn(vo.getOrdeSn());
        ...
        for (SkuWareHasStock hasStock : collect) {
            ...
            //2.锁定失败，前面保存的工作单信息就回滚了。发送出去的消息，即使要解锁记录，由于去数据库查询不到id，所以就不用解锁
    ...
    public void unlockStock(OrderTo orderTo) {
        ...
        //查一下最新库存的的状态，防止重复解锁库存
        WareOrderTaskEntity task = orderTaskService.getOrderTaskByOrderSn(orderSn);
        Long id = task.getId();
        //按照工作单，找到所有未解锁的库存，进行解锁
